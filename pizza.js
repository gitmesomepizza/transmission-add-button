window.onload = function(){
        document.getElementById("toolbar-pause-all").insertAdjacentHTML('afterend', '<div id="toolbar-separator"></div><div id="toolbar-pizza" title="Click me!"></div><div id="toolbar-pizza2" title="Port" style="display:none;">0</div>');
